...
/// 可视化开发功能实体
/// </summary>
[SugarTable(null, "可视化开发信息")]
[SystemTable]
public class VisualDev : EntityBase
{
    /// <summary>
    /// 名称
    /// </summary>
    ...
    /// 表单配置
    /// </summary>
    [SugarColumn(ColumnDescription = "表单配置JSON", ColumnDataType = StaticConfig.CodeFirst_BigString)]
    public string FormData { get; set; }

    /// <summary>
    /// 表单字典
    /// </summary>
    [SugarColumn(ColumnDescription = "表单字典", ColumnDataType = StaticConfig.CodeFirst_BigString)]
    public string? FormDict { get; set; }
