...
public class SysMenuSeedData : ISqlSugarEntitySeedData<SysMenu>
{
    ...
    public IEnumerable<SysMenu> HasData()
    {
        return new[]
        {
            ...
            new SysMenu{ Id=1310000000641, Pid=1310000000601, Title="系统接口", Path="/develop/api", Name="sysApi", Component="layout/routerView/iframe", IsIframe=true, OutLink="http://localhost:5001", Icon="ele-Help", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=130 },
            new SysMenu{ Id=1310000000651, Pid=1310000000601, Title="应用设计", Path="/develop/VisualDev", Name="sysVisualDev", Component="/system/VisualDev/index", Icon="ele-Chicken", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=140 },
            ...
            new SysMenu{ Id=1310000000713, Pid=1310000000701, Title="vueNextAdmin", Path="/doc/vuenextadmin", Name="vueNextAdmin", Component="layout/routerView/link", IsIframe=false, IsKeepAlive=false, OutLink="https://lyt-top.gitee.io/vue-next-admin-doc-preview/", Icon="ele-Position", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=120 },
