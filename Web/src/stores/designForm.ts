...
export const useDesignFormStore = defineStore('designForm', {
  ...
  actions: {
    ...
    setFormDesginData(data: any) {
      this.formDesginData = data
    },
    setFormData(data: any) {
      this.formDesginData.list = data
    },
    setFormAttr(data: any) {
      this.formDesginData.form = data
    },
  }
})
