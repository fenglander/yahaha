...
<template>
    <div v-loading="loading">
        <el-form v-bind="formData.form" ref="ruleForm" :model="model as any" :disabled="disabled || type === 3"
...
import FormGroup from './design/form/components/formGroup.vue'
import {
    computed,
    ref,
    watch,
...
import type { FormData, FormList } from './design/types'
...
import {
    ...
    constFormProps,
    appendOrRemoveStyle
} from './design/utils/utils'
import formatResult from './design/utils/formatResult'
import formChangeValue from './design/utils/formChangeValue'
import { jsonParseStringify } from './design/utils'
