export const baseAttrItem = [
    ...
    },
    {
        ...
        type: 'string',
        placeholder: '控制字段是否只读,最大支持关联字段3层,如[[\'Code\', \'==\', false],[\'qty\', \'>\', 0]]',
        path: 'readonlyExp',
        format:'json',
        show: ['and',
            ['isLayout', '==', false],
    ...
    },
    {
        ...
        type: 'string',
        placeholder: '控制字段是否必填,最大支持关联字段3层,如[1=1],[[\'Code\', \'==\', false],[\'qty\', \'>\', 0]]',
        path: 'requiredExp',
        format:'json',
        show: ['and',
            ['isLayout', '==', false],
    ...
    },
    {
        ...
        type: 'string',
        placeholder: '控制字段是否隐藏,最大支持关联字段3层,如[[\'Code\', \'==\', false],[\'qty\', \'>\', 0]]',
        path: 'invisibleExp',
        format:'json',
        show: ['and',
            ['isLayout', '==', false],
