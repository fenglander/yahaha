    ...
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item label="更新时间">
          <el-date-picker placeholder="请选择更新时间" value-format="YYYY/MM/DD" type="daterange"
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table :data="tableData" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
        ...
        <el-table-column label="操作" width="140" align="center" fixed="right" show-overflow-tooltip=""
          v-if="auth('inventory:edit') || auth('inventory:delete')">
          <template #default="scope">
            <el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditInventory(scope.row)"
              v-auth="'inventory:edit'"> 编辑 </el-button>
            <el-button icon="ele-Delete" size="small" text="" type="primary" @click="delInventory(scope.row)"
              v-auth="'inventory:delete'"> 删除 </el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <editDialog ref="editDialogRef" :title="editInventoryTitle" @reloadTable="handleQuery" />
    </el-card>
  </div>
</template>
